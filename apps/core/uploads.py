...
def carnet_contenu_upload_to(instance, filename):
    return _slugged("carnet/contenu", filename)
...
def boutique_upload_to(instance, filename):
    return _slugged("boutique", filename)
